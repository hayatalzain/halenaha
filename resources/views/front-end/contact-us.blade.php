                    ...
                    <div class="col-lg-6 v-center">
                        <div class="col">
                            <h5 class="text-green text-right text-icon mt-2 d-inline">
                                <img class="icon-order" src="{{asset('images/icon-setting.svg')}}"/>مشاكل الصيانة بعد الخدمة</h5>
                        ...
                        <div class="col">
                            ...
                            <p class="ml-4 mt-2" > <img class="icon-order" src="{{asset('images/icon-email.svg')}}"/>
{{--                                {!!getVal('ContactUs_Email')   !!}--}}
                                للتواصل مع الإدارة
                                <a class="text-green" href = "mailto:{{ $info[0]['Value'] ?? ''}}">
                                    {{ $info[0]['Value'] ?? ''}}
                                </a>
                            ...
                            <p class="ml-4 mt-2"> <img class="icon-order" src="{{asset('images/icon-phone.svg')}}"/>
{{--                                {!!getVal('ContactUs_Phone')   !!}--}}
                                {{ $info[1]['Value'] ?? ''}}

                            </p>
                            <p class="ml-4 mt-2"> <img class="icon-order" src="{{asset('images/icon-location.svg')}}"/>
                                Riyadh, Saudi Arabia
                            </p>
                        </div>
                        <hr>

                ...
                <div class="row">
                    <div class="col-lg-6 v-center">
                        <div class="header-heading">
                            ...
                            <a href="{{route('new.order')}}" class="btn-main lnk wow fadeInUp text-center mt-4" data-wow-delay=".6s"> اطلب الآن <span class="circle"></span></a>
                        </div>
                    </div>

                    <div class="col-lg-6 wow fadeIn" data-wow-delay=".4s">
                        <div class="single-image"><img  src="{{asset('images/Group1809.svg')}}" alt="service" class="img-fluid showin-mobile"/></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 mt30 wow fadeInUp w-50 " data-wow-delay=".2s">
                        <div class="s-block" data-tilt data-tilt-max="4" data-tilt-speed="1000">
                            <div class="s-card-icon">
                                <img src="{{asset('images/serv_broken_icon.svg')}}"
                    ...
                    <div class="col-md-3 col-sm-6 mt30 wow fadeInUp w-50" data-wow-delay=".2s">
                        <div class="s-block" data-tilt-speed="1000">
                            <div class="s-card-icon">
                                <img src="{{asset('images/serv_battery_icon.svg')}}" alt="بطارية" class="img-fluid2" />
                    ...
                    <div class="col-md-3 col-sm-6 mt30 wow fadeInUp w-50" data-wow-delay=".2s">
                        <div class="s-block" data-tilt data-tilt-max="4" data-tilt-speed="1000">
                            <div class="s-card-icon">
                                <img src="{{asset('images/serv_phone_icon.svg')}}" alt="زر الهوم" class="img-fluid2" />
                    ...
                    <div class="col-md-3 col-sm-6 mt30 wow fadeInUp w-50" data-wow-delay=".2s">
                        <div class="s-block" data-tilt data-tilt-max="4" data-tilt-speed="1000">
                            <div class="s-card-icon">
                                <img src="{{asset('images/serv_camera_icon.svg')}}" alt="كاميرا خلفية" class="img-fluid2" />
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 offset-md-3 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".2s">
                    <div class="s-block-why" data-tilt data-tilt-max="4" data-tilt-speed="1000">
                        <div class="s-card-icon">
                            <img src="{{asset('images/why1_icon.svg')}}" alt="صيانة  كسر شاشة " class="img-fluid1 why_icon" />
            ...
            <div class="row">
                <div class="col-md-6 offset-md-3 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".2s">
                    <div class="s-block-why" data-tilt data-tilt-max="4" data-tilt-speed="1000">
                        <div class="s-card-icon">
                            <img src="{{asset('images/why2_icon.svg')}}" alt="صيانة  كسر شاشة " class="img-fluid1 why_icon" />
            ...
            <div class="row">
                <div class="col-md-6 offset-md-3 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".2s">
                    <div class="s-block-why" data-tilt data-tilt-max="4" data-tilt-speed="1000">
                        <div class="s-card-icon">
                            <img src="{{asset('images/why3_icon.svg')}}" alt="صيانة  كسر شاشة " class="img-fluid1 why_icon" />
    ...
    <section class="about-freelance pad-tb" id="about">
        ...
        <div class="container p-3">
            <div class="row pro-max">
                <img class="img-fluid d-none d-lg-block d-xl-block" src="{{asset('images/update_img.png')}}">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 px-0">
                <img class="img-fluid" src="{{asset('images/full_img.svg')}}"/>
            </div>
        </div>
    </div>
   </section>
    ...
    <section class="about-freelance pad-tb" id="new_order">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="common-heading">
                        <h1 class="mb-2 text-center font-weight-bold"> يرجع لك سليم <img class="img-fluid" src="{{asset('images/smile.svg')}}" width="45"/> </h1>
                        <a href="{{route('new.order')}}" class="btn-main-fine lnk wow fadeInUp text-center mt-4" data-wow-delay=".6s"> اطلب الآن <span class="circle"></span></a>
                        {{--  <hr class="text-center line-main">--}}
                    </div>
                </div>
            </div>
        ...
        $(function () {
            $(document).scroll(function () {
                ...
                if ($(this).scrollTop() > $color_logo.height()) {
                    $('.id_logo').attr('src','{!! asset('images/logo-green.svg') !!}');
                }
                else {
                    $('.id_logo').attr('src','{!! asset('images/logo-white.svg') !!}');
                }
            });
        });

                    ...
                    <div class="col-md-6 col-12 mt-4">
                        ...
                        <div class="col-md-12">
                            <p class="text-green text-right text-icon ml-3 mt-2">
                                <img class="icon-order" src="{{asset('images/icon-phone.svg')}}"/>
                                 الشركة </p>
...
{{--                                        <option value="{{$device['Id']?? ''}}"  data-id="{{$count}}"> {{$device['NameAr']?? ''}}</option>--}}
{{--                                        <?php--}}
{{--                                        $count++;--}}
{{--                                        ?>--}}
{{--                                    @endforeach--}}
                        ...
                        <div class="col-md-12">
                            <p class="text-green text-right text-icon ml-3 mt-2">
                                <img class="icon-order" src="{{asset('images/icon-setting.svg')}}"/>
                                مشكلة الهاتف </p>
                            <div class="input-group mb-3 mt-3 px-5">
                        ...
                        <div class="col-md-12">
                            <p class="text-green text-right text-icon ml-3 mt-2">
                                <img class="icon-order" src="{{asset('images/icon-color.svg')}}"/>
                                لون الهاتف </p>
                            <div class="input-group mb-3 mt-3 px-5">
                       ...
                       <option value="{{$color['Id']?? ''}}"> {{$color['Name']?? ''}}</option>
                        ...
                        <div class="col-md-12">
                            <p class="text-green text-right text-icon ml-3 mt-2">
                                <img class="icon-order" src="{{asset('images/icon-date.svg')}}"/> موعد الصيانة </p>
                        ...
                        <div class="col-md-12">
                            <p class="text-green text-right text-icon ml-3 mt-2">
                                <img class="icon-order" src="{{asset('images/icon-note.svg')}}"/>ملاحظات   </p>
            ...
            <textarea class="form-control ml-5 w-82 mt-3" name="Comment" value='' placeholder="هل هناك ملاحظة تود اخبارنا بها"  id="comment" rows="3"></textarea>
                        ...
                        <div class="col-md-12">
                            <p class="text-green text-right text-icon ml-3 mt-2">
                                <img class="icon-order" src="{{asset('images/coupon.svg')}}"/> ادخل كود العرض الترويجي </p>
                            <div class="form-group px-5">
                    ...
                    <div class="col-md-6 col-12 mt-4">
                        <h5 class="text-green text-right text-icon mb-2">
                            <img class="icon-order" src="{{asset('images/icon-location.svg')}}"/>
                            الموقع
...
{{--                        onclick="window.location.href='/css_page.html'"--}}
                        <!--Google Maps-->
{{--                        <div class="col">--}}
{{--                            <h5 class="mt-4">--}}
{{--                                <span class="text-green"> تنويه:</span>--}}
{{--                            </h5>--}}
{{--                            <p class="blue_font m-0">--}}
{{--                                في حال عدم ظهور الخريطة تأكد من--}}
{{--                                إعدادات الخصوصية--}}
{{--                                في جهازك بالسماح للوصول إلى الموقع أو قدم طلبك من خلال--}}
{{--                                تطبيقنا--}}
{{--                                <a class="text-green" href="https://apps.apple.com/sa/app/%D8%AD%D9%84%D9%8A%D9%86%D8%A7%D9%87%D8%A7/id1383515855">--}}
{{--                                    نزل التطبيق</a>--}}
{{--                            </p>--}}
{{--                        </div>--}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-2 ">
                            <div class="custom-control custom-switch mt-2">
                                <input type="checkbox" class="custom-control-input" id="customSwitches-{{$count}}">
                                <label class="custom-control-label" for="customSwitches-{{$count}}"></label>
                            </div>
{{--   <input type="checkbox" id="toggle-event" data-toggle="toggle" data-style="ios" value="1"  >--}}
                        </div>
                        <div class="col-1"></div>
                    </div>
                        <hr>
                    ...
                    <button id="submit_data" class="btn btn-accept " data-count="{{$count}}">
                        <i> تـم</i>
                    </button>
                </div>
                        ...
                        <div class="container-fluid">
                            <div id="login-row" class="row justify-content-center align-items-center">
                              ...
                              <li class="list-inline-item mx-3 my-2 "  >
                                  ...
                                  <a class="custom-link-list day_id english_num_test" id="day-{{$count}}" data-text="{{$day['Name']?? ''}} {{$day['DateFormatted']?? ''}}" data-days-id="{{$count}}" data-value="{{$day['Date']?? ''}}" href="#" >

                                      {{$day['Name']?? ''}}
                                  <br>
                                  <br>
                                      <span class="english_num_test">{{$day['DateFormatted']?? ''}}</span>
                                  </a></li>|
                                                 <?php
                                                 $count++;
                                                 ?>
                                        ...
                                        @foreach ($appointments as $appointment)
                                               ...
                                               data-name="{{$appointment['Name']?? ''}} " value="{{$appointment['Id']?? ''}}"  {{ $appointment['IsActive']==true ? '' : 'disabled' }}>{{$appointment['Name']?? ''}}
                                                    </label></div>
                                            <hr>
                                            @endforeach
...
// console.log(data)
    ...
    $.ajax({
        ...
        success: function(res,data){
            if(res['success']==1){
                window.location = '{{ url('successfully-order') }}';
                $.session.clear();
            }
            else{
                if ( res['popup']== 0){

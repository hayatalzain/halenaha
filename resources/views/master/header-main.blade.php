...
{{--    <title>حليناها - الصفحة الرئيسية </title>--}}

    <title>@yield('title')  خدمة حليناها -</title>

    @yield("script_ceo_main")
    @yield("script_ceo_new_order")
    @yield("script_ceo_successfully")
...
<header class="top-header header-pr">
    <nav class="navbar navbar-expand-lg navbar-light justify-content-right navbar-mobile fixed-top navfix">
        <div class="container">
            <a class="navbar-brand" href="{{route('index')}}"> <img class="id_logo" src="{{asset('images/logo-white.svg')}}" alt="Logo" width="100" /></a>
            ...
            <div class="collapse navbar-collapse animate slideIn mobile-none" id="navbar4">
                ...
                <ul class="navbar-nav d-menu">
                    ...
                    ?>
                    <li class="nav-item"> <a class="nav-link custom-btn lnk btn-main-header px-4" href="{{route('login')}}">حسابي <span class="circle"></span></a> </li>
                </ul>
            </div>
    ...
    <nav id="main-nav">
        <ul class="first-nav">
            ...
            <li><a href="{{route('update.profile.store')}}">حسابي</a>
            </li>
            <?php
            if ( Session::has('Id')) {

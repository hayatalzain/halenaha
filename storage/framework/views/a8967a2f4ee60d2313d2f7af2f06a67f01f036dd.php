            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 col-sm-12 text-center">
                    <ul class="footer-link-v2 link-hover mt30">
                        ...
                        <li><a href="<?php echo e(route('about-us')); ?>"> عن
                                حليناها</a></li>
                        <span class="menu-line-footer">|</span>
                        <li><a href="<?php echo e(route('faq')); ?>">مساعدة </a></li>
                        <span class="menu-line-footer">|</span>
                        <li><a href="<?php echo e(route('contact-us')); ?>">تواصل معنا </a></li>
                    ...
                    <div class="footer- mt-3 text-center">
                        <p class="copyright-footer english_num" >   Halenaha - All rights reserved &copy; <?php echo e(date('Y')); ?>  </p>
                    </div>
                </div>
            </div>
        </div>
...
<script src="<?php echo e(asset('js/plugin.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/preloader.js')); ?>"></script>
<script src="<?php echo e(asset('js/jquery.session.js')); ?>"></script>
...
<?php /**PATH C:\wamp64\www\newh\resources\views/master/footer.blade.php ENDPATH**/ ?>
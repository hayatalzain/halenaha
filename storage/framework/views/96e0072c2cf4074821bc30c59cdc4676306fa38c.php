        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <p class="text-green text-right text-icon ml-3 mt-2 d-inline">
                            <img class="icon-order" src="<?php echo e(asset('images/icon-date.svg')); ?>"/>  تاريخ الطلب</p>
                        <p class=" ml-5 mt-2 d-inline english_num_pure"> <?php echo e(date('Y-m-d', strtotime($orders["RequestDate"])) ?? ''); ?>

                           </p>


                        <p class=" ml-5 mt-2 d-inline english_num_pure">  <?php echo e(date('H:i A', strtotime($orders["RequestDate"])) ?? ''); ?></p>
                    </div>

                    <div class="col-md-12">
                        <p class="text-green text-right text-icon pl-3 ml-4 mt-2 d-inline"> رقم الطلب</p>
                        <p class="ml-5 mt-2 d-inline english_num_pure">  <?php echo e($orders['Code'] ?? ''); ?></p>
                    </div>
                    <hr>
                    <div class="col-md-12">
                        <p class="text-green text-right text-icon ml-3 mt-2">
                            <img class="icon-order" src="<?php echo e(asset('images/icon-clock.svg')); ?>"/>
                            حالة الطلب</p>
                        <p class=" ml-5 mt-2"> <?php echo e($orders["OrderStatus"] ?? ''); ?></p>

                    </div>
                    <hr>
                    <div class="col-md-12">
                        <p class="text-green text-right text-icon ml-3 mt-2">
                            <img class="icon-order" src="<?php echo e(asset('images/icon-date.svg')); ?>"/> تاريخ تلقي الخدمة </p>
                        <p class="ml-5 mt-2">
                            من 	&nbsp; <span class="english_num_pure"><?php echo e($orders['AppointmentStartTimeFormatted']); ?></span>
                            &nbsp;الى	&nbsp; <span class="english_num_pure"><?php echo e($orders['AppointmentEndTimeFormatted']); ?> </span></p>

                        <p class="ml-5 mt-2">بتاريخ	&nbsp; <span class="english_num_pure"> <?php echo e($orders['AppointmentDateFormatted']); ?></span></p>
                    </div>
                    <hr>
                    <div class="col-md-12">
                        <p class="text-green text-right text-icon ml-3 mt-2">
                            <img class="icon-order" src="<?php echo e(asset('images/icon-phone.svg')); ?>"/>  نوع الهاتف </p>
                        <p class="ml-5 mt-2"> <?php echo e($orders["DeviceNameAr"] ?? ''); ?></p>
                    </div>
                    <hr>
                    <div class="col-md-12">
                        <p class="text-green text-right text-icon ml-3 mt-2">
                            <img class="icon-order" src="<?php echo e(asset('images/icon-setting.svg')); ?>"/>  مشكلة الهاتف </p>
                        <p class="ml-5 mt-2">  <?php echo e($orders["IssueNameAr"] ?? ''); ?></p>
                    </div>
                    ...
                    <div class="col-md-12">
                        <p class="text-green text-right text-icon ml-3 mt-2">
                            <img class="icon-order" src="<?php echo e(asset('images/icon-color.svg')); ?>"/>  لون الهاتف </p>
                        <p class="ml-5 mt-2"><?php echo e($orders["ColorName"] ?? ''); ?> </p>
                    </div>

                    <hr>
                    <div class="col-md-12">
                        <p class="text-green text-right text-icon ml-3 mt-2">
                            <img class="icon-order" src="<?php echo e(asset('images/icon-note.svg')); ?>"/>   تعليقات العميل على الخدمة  </p>
                        <p class="ml-5 mt-2">  <?php echo e($orders["Comment"] ?? ''); ?> </p>
                    </div>
                    <hr>
                    ...
                    <div class="col-md-12">
                        <p class="text-green text-right text-icon ml-3 mt-2">
                            ...
                            <span class="english_num_pure">  <?php echo e($orders["IssueMaxPrice"] ?? ''); ?> </span>  </p>
                ...
                <div class="row send-data">
                    ...
                    <div class="form-group">
                        <a type="button"  href="<?php echo e(route('orders')); ?>" name="submit" class="btn btn-cancel-gray btn-md" >رجوع
                        </a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="container-fluid">
                            <div id="login-row" class="row justify-content-center align-items-center">
                                <div id="login-column" class="col-md-12">
                                    <form id="login-form" class="form" action="<?php echo e(route('cancel.order')); ?>" method="get">
                                        ...
                                        <div class="input-group mb-3 mt-3 px-3">
                                            <select class="custom-select" id="reject_id" name="ReasonId" aria-label="Example select with button addon">
                                                ...
                                                <?php $__currentLoopData = $rejects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option  value="<?php echo e($reject['Id']?? ''); ?>"> <?php echo e($reject['Name']?? ''); ?></option>
    ...
    <script async
        ...
        <script type="text/javascript">
            function initMap() {
                ...
                const myLatlng = { lat: <?php echo e($orders["Lat"] ?? ''); ?>, lng: <?php echo e($orders["Long"] ?? ''); ?> };

                map = new google.maps.Map(document.getElementById("map"), {
                    zoom: 10,
                    center: myLatlng,
                });
                var latlng = new google.maps.LatLng(<?php echo e($orders["Lat"] ?? ''); ?>, <?php echo e($orders["Long"] ?? ''); ?>);
